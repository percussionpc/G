...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Grovcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Grovcoin Core"
...
#define PACKAGE_NAME "Grovcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Grovcoin Core 0.18.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "grovcoin"
