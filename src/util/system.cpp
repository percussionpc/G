...
const char * const BITCOIN_CONF_FILENAME = "grovcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Grovcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Grovcoin";
#else
    // Unix
    return pathRet / ".grovcoin";
#endif
#endif
}
