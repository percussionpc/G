...
pkgdatadir = $(datadir)/grovcoin
pkgincludedir = $(includedir)/grovcoin
pkglibdir = $(libdir)/grovcoin
pkglibexecdir = $(libexecdir)/grovcoin
...
ACLOCAL = ${SHELL} /root/grovcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/grovcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/grovcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/grovcoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = grovcoin-cli
BITCOIN_DAEMON_NAME = grovcoind
BITCOIN_GUI_NAME = grovcoin-qt
BITCOIN_TX_NAME = grovcoin-tx
BITCOIN_WALLET_TOOL_NAME = grovcoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Grovcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Grovcoin Core
COPYRIGHT_YEAR = 2020
CPP = gcc -E
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /root/grovcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = grovcoin
PACKAGE_BUGREPORT = https://github.com/grovcoin-project/grovcoin/issues
PACKAGE_NAME = Grovcoin Core
PACKAGE_STRING = Grovcoin Core 0.18.1
PACKAGE_TARNAME = grovcoin
PACKAGE_URL = https://grovcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /root/grovcoin
abs_srcdir = /root/grovcoin
abs_top_builddir = /root/grovcoin
abs_top_srcdir = /root/grovcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/grovcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Grovcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Grovcoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Grovcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Grovcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
