# Support for Output Descriptors in Grovcoin Core

Since Grovcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Grovcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Grovcoin Core wallets, a convenience function `combo` is
